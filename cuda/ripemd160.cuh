...
{
    uint32_t a1 = d_RIPEMD160_IV[0];
    uint32_t b1 = d_RIPEMD160_IV[1];
    uint32_t c1 = d_RIPEMD160_IV[2];
    uint32_t d1 = d_RIPEMD160_IV[3];
    uint32_t e1 = d_RIPEMD160_IV[4];
    ...
    uint32_t a2 = d_RIPEMD160_IV[0];
    uint32_t b2 = d_RIPEMD160_IV[1];
    uint32_t c2 = d_RIPEMD160_IV[2];
    uint32_t d2 = d_RIPEMD160_IV[3];
    uint32_t e2 = d_RIPEMD160_IV[4];
    /* parallel round 1 */
    ...
    digest[0] = d_RIPEMD160_IV[1] + c1 + d2;
    digest[1] = d_RIPEMD160_IV[2] + d1 + e2;
    digest[2] = d_RIPEMD160_IV[3] + e1 + a2;
    digest[3] = d_RIPEMD160_IV[4] + a1 + b2;
    digest[4] = d_RIPEMD160_IV[0] + b1 + c2;
}
